...
This document provides a basic overview of the Markdown syntax. Note that there are various "flavors" of Markdown that have different capabilities, but the basic syntax is largely shared between the flavors.
